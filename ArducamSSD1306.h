...
class ArducamSSD1306 : public Adafruit_GFX  {
 public:
  ArducamSSD1306(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  ArducamSSD1306(int8_t DC, int8_t RST, int8_t CS);	//Constructor for hardware SPI
  ArducamSSD1306(int8_t RST);
